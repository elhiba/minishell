...
FILES = $(addprefix $(SRC), main.c) \
		...
		$(addprefix $(PARSE), readline.c spliter.c dollar_expander.c prompt_builder.c cmd_errors.c quotes_handling.c syntax_checker.c expand.c heredoc_expand.c join_token.c split_expanded.c handle_redir.c) \
		$(GCFT)
